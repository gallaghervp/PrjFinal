...
<html>
<head>
    <title>ChipJobs - Fabricante</title>
            ...
            <div class="col-sm-9 col-sm-offset-3 main">
                ...
                <div class="card-dados-container">
                   ...
                   <div class="form-group">
                        ...
                        <div class="col-sm-9 has-feedback">
                            <input type="text" class="form-control form-page" name="enderecofabri" id="txtEnderecoFabri" placeholder="Endereço">
                   ...
                   <div class="form-group">
                    ...
                    <div class="form-group">
                       ...
                       <div class="form-group">
                        ...
                        <div class="col-sm-9 has-feedback">
                            <input type="text" class="form-control form-page" name="municipiofabri" id="txtMunicipioFabri" placeholder="Município">
                            <i class="fa fa-address-card form-control-feedback"></i>
                        </div>
                    </div>
