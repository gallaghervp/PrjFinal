...
<html>
<head>
    <title>ChipStore - Carrinho-logado</title>
        ...
        <div class="parallax-container" id="parallaxUser" data-speed="6" data-type="background">
            <div class="container">
                <div class="row">
                    ...
                    <ol class="breadcrumb">
                        <li><a href="indexLogado.jsp">Início</a></li>
    ...
    <div class="container">
        <table id="cart" class="table table-hover table-condensed">
            ...
            <tfoot>
                ...
                <tr>
                    <td><a href="indexLogado.jsp" class="btn btn-warning"><i class="fa fa-angle-left"></i> Continue Comprando</a></td>
